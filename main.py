...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    "🌿 Я — ЭлаЙа, магический помошник. Задай вопрос или выбери команду.\n\n"
...
app.add_handler(CommandHandler("help", help_command)(MessageHandler(filters.TEXT, handle_message))
